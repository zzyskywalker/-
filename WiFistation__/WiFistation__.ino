...
#define INTERVAL_NET      17000             //定义发送时间#include "./ESP8266.h"
#include "U8glib.h"
...
#define SSID           "E"                   // cannot be longer than 32 characters!
...
#define DEVICEID   "20450858"
#define PROJECTID "106243"
#define HOST_PORT   (80)
String apiKey="MUA2tymoTEfrvn5gETrVd2go1fU=";
char buf[10];
...
jsonToSend="{\"Temperature\":";
  ...
  getSensorData();                                          //读串口中的传感器数据
    u8g.firstPage();                                      //OLED输出
    do {
        setFont_L;
        u8g.setPrintPos(10, 10);                          //坐标定位输出位置
        u8g.print("Temp: ");
        u8g.print(sensor_tem_c);
        u8g.print("C");
        u8g.setPrintPos(10, 30);                          //简单输出三组数据
        u8g.print("Hum: ");
