...
sbit LED=P4^2;//信号指示灯
sbit PA1=P1^0; //定义IO口对应板上标号 P1.0
sbit PA2=P1^1;  //定义IO口对应板上标号 P1.1
sbit PA3=P1^2;  //.....
...
void 	User_handle(uint8 dat)
{
     //UARTSendByte(dat);//串口识别码（十六进制）
			 ...
			 switch(dat)		   /*对结果执行相关操作,客户修改*/
			  {
                    case a:	 /*命令“全开”*/
						PrintCom("“结束001”命令识别成功\r\n");//串口输出提示信息（可删除）
						PA1=0;//让PA1端口为低电平
						PA2=0;//让PA2端口为低电平
						PA3=1;//让PA3端口为低电平
													 break;
					case b:		/*命令“复位”*/				
						PrintCom("“前进010”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=0;//让PA1端口为低电平
						PA2=1;//让PA2端口为高电平
						PA3=0;//让PA3端口为低电平
													break;
					case c:		/*命令“复位”*/				
						PrintCom("“后退011”命令识别成功\r\n"); //串口输出提示信息（可删除）
					    PA1=0;//让PA1端口为低电平
						PA2=1;//让PA2端口为高电平
						PA3=1;//让PA3端口为高电平
													break;
					case d:		/*命令“复位”*/				
						PrintCom("“左转100”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=1;//让PA1端口为高电平
						PA2=0;//让PA2端口为低电平
						PA3=0;//让PA3端口为低电平
													break;
					case e:		/*命令“复位”*/				
						PrintCom("“右转101”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=1;//让PA1端口为高电平
						PA2=0;//让PA2端口为低电平
						PA3=1;//让PA3端口为高电平
													break;
					case f:		/*命令“复位”*/				
						PrintCom("“启动避障模式110”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=1;//让PA1端口为高电平
						PA2=1;//让PA2端口为高电平
						PA3=0;//让PA3端口为低电平
					case h:		/*命令“复位”*/				
						PrintCom("“退出避障模式111”命令识别成功\r\n"); //串口输出提示信息（可删除）
						PA1=1;//让PA1端口为高电平
						PA2=1;//让PA2端口为高电平
						PA3=1;//让PA端口为高电平
													break;																											
